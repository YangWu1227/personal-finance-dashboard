...
from app.modules.spending_tracker import layout as spending_tracker_layout, register_callbacks as register_spending_tracker_callbacks
...
def toggle_sidebar(n, sidebar_style: Dict[str, str], below_nav_style: Dict[str, str], navbar_style: Dict[str, str]) -> Tuple[Dict[str, str], Dict[str, str], Dict[str, str]]:
    ...
    if n and (n % 2 == 1):  # If the number of clicks is odd, hide the sidebar
        ...
        sidebar_style = {'position': 'fixed', 'top': 0, 'left': 0, 'bottom': 0, 'width': '16rem', 'padding': '2rem 1rem', 'background-color': '#f8f9fa'} # type: ignore
